...
class JWT(JWTMode, JWTTokenType):
    ...
    def get_response(
        ...
        tokens: Dict[str, Any] = {}
        token_types: List[str] = list(filter(
        ...
        for t in token_types:
            ...
            tokens[f'{t}_token']: str = token.credential
            tokens[f'{t}_token_expires']: str = token.expires_in

        response: response_type = response_type(content=tokens)
